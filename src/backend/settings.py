...
Adapted for Docker + PostgreSQL environment.
"""
...
SECRET_KEY = 'django-insecure-1_+xu0ceiqc6ma%6)r+#t7j_7v=ike$jlqym_1@uyhu9a&kj1t'
...
# Media files (User uploads - ex: CVs)
MEDIA_URL = 'media/'
MEDIA_ROOT = BASE_DIR / 'media'

# CORS Settings (Si tu utilises une API externe plus tard)
